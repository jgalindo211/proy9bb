...
lds = utilidad.getDatosSolicitudes(usuario);
tamanio = lds.size();
                                ...
                                <td width="365" height="100%" align="left" valign="top">
                                    <table width="558" border="0" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            ...
                                            <html:form action='/solicitudReqAction' method='post' enctype='multipart/form-data'>
                                                    ...
                                                    <input type="hidden" name="tipos" id="tipos" value="<%=ESAPI.encoder().encodeForHTMLAttribute(tDocu)%>" />
                                                            ...
                                                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                                <tr>
                                                                    <td width="50%" class="verd9azul">
                                                                        <html:file property='file1'  styleId='file1' onchange="loadDoc(this)" accept='application/pdf' />
                                                                    </td>
                                                                    <td width="50%" class="verd12azul">
                                    ...
                                    <html:form styleId='ane' action='/solicitudReqAnexosAction' method='post' enctype='multipart/form-data'>
                                    <div id="F2" class="divtipo">
                                    ...
                                    <tr class="verd11azul">
                                        <td>
                                            <%=ESAPI.encoder().encodeForHTMLAttribute(ds.getReqFecha())%>
                                        </td>
                                        <td>
