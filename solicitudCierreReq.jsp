...
hm = utilidad.getDatosSolicitudesAnexoCierre(usuario);
...
<html>
                            ...
                            <tr>
                                ...
                                <td width="365" height="100%" align="left" valign="top">
                                    <table width="558" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td class="verd12azul">
                                                <strong>Cierre de Requerimientos</strong>
                                            </td>
                                        </tr>
                                        <tr>
                                    ...
                                    <html:form styleId='cie' action='/solicitudReqCierreAction' method='post' enctype='multipart/form-data'>
                                    <input type="hidden" name="padreId" id="padreId" value="<%=ESAPI.encoder().encodeForHTMLAttribute("")%>" />
                                    <input type="hidden" name="detalleId" id="detalleId" value="<%=ESAPI.encoder().encodeForHTMLAttribute("")%>" />
                      ...
                      <?audit suppress oracle.ide.xml.validation-error?>
                                    ...
                                    <%
                                        for (DatosAnexos dan : lda) {
                                                sb = new StringBuffer("return seleccionarMostrarAnexo('");
                                    ...
                                    %>
                                        ...
                                        <td class="verd9azul">
                                            <%
                                                sb = new StringBuffer("return cerrarSolicitud('");
                                                sb.append(ESAPI.encoder().encodeForJavaScript(key));
                                                sb.append("')");
                                            %>
                                            <html:submit styleClass="submitCierre" onclick="<%=sb.toString()%>" />
                                        </td>
                                    </tr>
                                <%
                                    }//for Map
    ...
    <script type="text/javascript">
        ...
        function cerrarSolicitud(valorReqId)
        {
            document.getElementById('operacion').value='CERRAR';
            document.getElementById('padreId').value=valorReqId;
            var form = document.getElementById('cie');
            form.target="_self";
            return true;
        }
        
        function seleccionarMostrarAnexo(valorAnrId, valorReqId)
        {
            document.getElementById('operacion').value='MOSTRAR';
            document.getElementById('detalleId').value=valorAnrId;
            document.getElementById('padreId').value=valorReqId;
            var form = document.getElementById('cie');
            form.target="_blank";
            return true;
