...
UTL_EMAIL,
PERIODICIDAD) VALUES (
'CIF_NOTIFICACION_ENVIO',
'REGISTRO DE NOTIFICACION ENVIO DE APROBACION',
'A',
'N',
'S',
'D'
...
PERIODICIDAD) VALUES (
'CIF_NOTIFICA_CIERRE',
'REGISTRO DE NOTIFICACION CIERRE DE SOLICITUD',
'A',
'N',
'S',
'D'
...
UTL_EMAIL,
PERIODICIDAD) VALUES (
'CIF_NOTIFIC_ENVIO_HLP',
'NOTIFICACION ENVIO ADJUNTOS HELPDESK',
'A',
'N',
'S',
'D'
...
PERIODICIDAD) VALUES (
'CIF_APROBACION_REQ',
'REGISTRO DE APROBACION DE SOLICITUD',
'A',
'N',
'S',
'D'
...
UTL_EMAIL,
PERIODICIDAD) VALUES (
'CIF_NOTIFICA_RECHAZO',
'REGISTRO DE NOTIFICACION RECHAZO SOLICITUD',
'A',
'N',
'S',
'D'
...
'<p> <span style="font-family:verdana;font-size:12">Estimado(a) <#REQ_NOMBRE#>:</span><br/><br/><span style="font-family:verdana;font-size:12">Se le comunica que su solicitud <#REQ_ID#> ha sido</span> <span style="font-family:verdana;font-size:12;font-weight:bold"><u><#REQ_ESTADO#></u></span>.</p>',
...
'CI',
'Sistema de Anexo de Requerimientos',
'N',
'N'
);

INSERT INTO PA.PARAM_GENERALES (
ABREV_PARAMETRO,
COD_SISTEMA,
DESCRIPCION,
VALOR
