...
hm = utilidad.getDatosSolicitudesAnexoAprobacion(usuario);
...
<html>
                    ...
                    <td width="818" align="left" valign="top">
                            ...
                            <tr>
                                ...
                                <td width="365" height="100%" align="left" valign="top">
                                    <table width="558" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td class="verd12azul">
                                                <strong>Aprobar/Denegar Requerimientos</strong>
                                            </td>
                                        </tr>
                                        <tr>
                                    ...
                                    <html:form styleId="apr" action="/solicitudReqAprobacionRechazoAction"  method="post" enctype="multipart/form-data">
                      ...
                      <?audit suppress oracle.ide.xml.validation-error?>
                                    ...
                                    %>
                                        ...
                                        <td class="verd9azul">
                                            <%
                                                sb = new StringBuffer("return aprobarSolicitud('");
                                                sb.append(ESAPI.encoder().encodeForJavaScript(key));
                                                sb.append("')");
                                            %>
                                            <html:submit styleClass="submitAprobar" onclick="<%=sb.toString()%>" />
                                        </td>
                                        <td class="verd9azul">
                                            <%
                                                sb = new StringBuffer("return denegarSolicitud('");
                                                sb.append(ESAPI.encoder().encodeForJavaScript(key));
                                                sb.append("')");
                                            %>
                                            <html:submit styleClass="submitDenegar" onclick="<%=sb.toString()%>" />
                                        </td>
                                    </tr>
                                <%
                                    }//for Map
    ...
    <script type="text/javascript">
        ...
        function aprobarSolicitud(valorReqId)
        {
            document.getElementById('operacion').value='APROBAR';
        ...
        function denegarSolicitud(valorReqId)
        {
            document.getElementById('operacion').value='DENEGAR';
            document.getElementById('general').value=valorReqId;
            var form = document.getElementById('apr');
            form.target="_self";
            return true;
