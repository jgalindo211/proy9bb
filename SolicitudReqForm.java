...
public class SolicitudReqForm extends ValidatorForm {
    @SuppressWarnings("compatibility:-3462704082581229308")
    private static final long serialVersionUID = -6124191563243920592L;
            ...
            if (!"ENVIAR".equals(ope)) {
                ...
                if (file1 == null) {
                    ...
                    errors.add("common.file.err", new ActionMessage("error.common.file.size"));
                        ...
                        errors.add("common.file.err", new ActionMessage("error.common.file.required"));
                } else if ("application/pdf".equals(file1.getContentType())) {
                    try {
